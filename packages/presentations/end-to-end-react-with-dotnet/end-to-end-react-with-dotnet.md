...
<img class="icon" src="/presentations/end-to-end-react-with-dotnet/nunit-color.svg">
...
<!--<img class="icon" src="/presentations/end-to-end-react-with-dotnet/polly-logo.svg">-->
...
- Bundler with [rollup.js](https://rollupjs.org)
